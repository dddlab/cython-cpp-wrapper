...
def graphical_concord(sam_cov, lam1 = 0.1, lam2 = 0, method = 'ista', 
    ...
    update_h = np.repeat(0.0, maxit)
    iter_c = np.array([0], dtype = np.int32)

    libcd.gconcord(s, p, mth, lambda1, lam2, tol, maxit, steptype, out, outi, outj, update_h, iter_c)

    print("#### update_hist:", (update_h))
    print("#### iter_count:", (iter_c))
